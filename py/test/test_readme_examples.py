# Zoom SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ZoomSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ZoomSDK(...) and ZoomSDK.test(...) become
#      ZoomSDK.test({"entity": {...}}) seeding one mock record (id "test01")
