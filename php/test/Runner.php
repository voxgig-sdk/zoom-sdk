...
class ZoomTestRunner
{
    ...
    {
        $live = self::getenv('ZOOM_TEST_LIVE');
        $override = self::getenv('ZOOM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ZOOM_TEST_EXPLAIN');
...
class_alias('ZoomTestRunner', 'Runner');
class_alias('ZoomHelpers', 'Helpers');
