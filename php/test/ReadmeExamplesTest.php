...
// Zoom SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ZoomSDK::test)
...
{
    private const SDK_CLASS = 'ZoomSDK';
    ...
    private const SDK_BASE = 'zoom_sdk';
