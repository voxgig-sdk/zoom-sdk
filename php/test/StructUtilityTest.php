...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ZoomOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ZoomOmni::structfix($now, Struct::undef()))
                        !== json_encode(ZoomOmni::structfix($val, Struct::undef()))) {
