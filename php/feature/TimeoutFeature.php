...
class ZoomTimeoutFeature extends ZoomBaseFeature
{
    ...
    private function _with_timeout(ZoomContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ZoomContext $_ctx, float $ms): void
    {
        $client = $this->client;
