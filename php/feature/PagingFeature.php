...
class ZoomPagingFeature extends ZoomBaseFeature
{
    ...
    private function _graphql_pre_request(ZoomContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(ZoomContext $ctx): bool
    {
