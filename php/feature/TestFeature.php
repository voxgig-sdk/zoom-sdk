...
class ZoomTestFeature extends ZoomBaseFeature
{
    ...
    public function init(ZoomContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ZoomContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ZoomContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ZoomContext $ctx, $op, $args): array
    {
