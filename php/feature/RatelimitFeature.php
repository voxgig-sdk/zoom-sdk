...
class ZoomRatelimitFeature extends ZoomBaseFeature
{
    ...
    private function _acquire(ZoomContext $ctx): void
    {
    ...
    private function _track(ZoomContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
