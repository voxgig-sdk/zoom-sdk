...
class ZoomFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ZoomSDK/1.0)';
    ...
    public static function call(ZoomContext $ctx, string $fullurl, array $fetchdef): array
    {
