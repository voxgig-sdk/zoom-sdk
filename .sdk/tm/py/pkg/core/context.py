...
from projectname_sdk.core.control import ZoomControl
...
class ZoomContext:
    ...
    def make_error(self, code, msg):
        return ZoomError(code, msg, self)
