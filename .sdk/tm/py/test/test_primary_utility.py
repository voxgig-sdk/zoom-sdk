...
from projectname_sdk import ZoomSDK
from projectname_sdk.core.spec import ZoomSpec
from projectname_sdk.core.result import ZoomResult
from projectname_sdk.core.response import ZoomResponse
from projectname_sdk.core.operation import ZoomOperation
from projectname_sdk.core.error import ZoomError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ZoomBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ZoomSDK.test(None, None)
        ...
        class TestInitFeature(ZoomBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ZoomBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ZoomSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ZoomSDK.test(None, setup_opts)
