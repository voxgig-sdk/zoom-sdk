...
class ZoomTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ZoomTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ZoomTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ZoomTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
