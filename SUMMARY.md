...
Results: The created meeting; A page of meetings; The requested meeting; Deleted; Updated.
...
| [Meeting](docs/api/meeting.html) | `update` | `PATCH /meetings/{meetingId}` | Required |
...
- `zoom_list`: List records for an entity. Supported entities: `meeting`.
- `zoom_load`: Load one record for an entity. Supported entities: `meeting`.
