...
class MeetingEntity extends ZoomEntityBase<Meeting> {
  ...
  async load(this: any, reqmatch?: MeetingLoadMatch, ctrl?: Control): Promise<MeetingEntity> {
  ...
  async update(this: any, reqdata?: MeetingUpdateData, ctrl?: Control): Promise<MeetingEntity> {
